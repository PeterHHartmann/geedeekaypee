...
export async function CharacterRoleSelect() {
    ...
    return (
        <div className='w-full'>
            ...
            <select name='role_id' id='role_id' className='peer block w-full rounded-md border-2 border-primary-500 py-[9px] pl-10 text-sm outline-2 placeholder:text-gray-500 text-primary-950 bg-death-knight' required>
