...
export async function CharacterClassSelect() {
    ...
    return (
        <div className='w-full'>
            ...
            <select name='class_id' id='class_id' className='peer block w-full rounded-md border-2 border-primary-500 py-[9px] pl-10 text-sm outline-2 placeholder:text-gray-500 text-primary-950' required>
