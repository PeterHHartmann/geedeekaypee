...
const raids_template_positions = {
    icc25hc: {
        ...
        positions: {
            1: {
                id: '2b4802fb-65c1-4927-9dd4-3e3808b70545',
                priority_list: [
                    {class_roles: class_roles.deathknight.tank.id, spec_id: class_talent_specs.deathknight.blood.id},
                    {class_roles: class_roles.paladin.tank.id, spec_id: class_talent_specs.paladin.protection.id},
                ]
            },
            2: {
                id: '3abd86c7-d5ae-4bb5-a46f-116fa1b6f305',
                priority_list: [
                    {class_roles: class_roles.paladin.tank.id, spec_id: class_talent_specs.paladin.protection.id},
                    {class_roles: class_roles.deathknight.tank.id, spec_id: class_talent_specs.deathknight.blood.id},
                ]
    ...
    icc10hc: {
        ...
        positions: {
            1: {
                id: '1e9b8cf4-01a6-46da-8a77-c446d080ad7a',
                priority_list: [
                    {class_roles: class_roles.deathknight.tank.id, spec_id: class_talent_specs.deathknight.blood.id},
                    {class_roles: class_roles.paladin.tank.id, spec_id: class_talent_specs.paladin.protection.id},
                ]
            ...
            2: {
                id: '95e0fcfa-d20b-4d9e-a9b8-41359bb44985',
                priority_list: [
                    {class_roles: class_roles.paladin.tank.id, spec_id: class_talent_specs.paladin.protection.id},
                    {class_roles: class_roles.deathknight.tank.id, spec_id: class_talent_specs.deathknight.blood.id},
                ]
