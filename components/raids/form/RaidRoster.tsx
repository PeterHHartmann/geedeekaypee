...
export function RaidRoster({
    ...
    return (
        <>
            <div className='grid grid-flow-column grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 rounded-md overflow-clip sm:divide-x divide-solid divide-slate-500 dark:divide-slate-600 shadow-md shadow-slate-800 '>
